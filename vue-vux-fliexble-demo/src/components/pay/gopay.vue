            ...
            <dd>
                <dl>
                    ...
                    <dd class="kv-line-r dd-padding">
                        <h6>总额：</h6>
                        <p>
                            <strong class="color-stronger highlight-price">{{total_amount}}元</strong>
                        </p>
                    </dd>
                </dl>
            </dd>
        ...
        <div id="pay-methods-panel" class="pay-methods-panel">
           ...
           <form id="pay_form">
                ...
                <div class="wrapper buy-wrapper">
                    <a href="javascript:void(0);" class="J-btn-submit btn mj-submit btn-strong btn-larger btn-block" @click="isPay">确认支付</a>
                </div>
            </form>
        </div>
    </div>
    ...
    methods:{
        ...
        isPay(){
            ...
            openid:'oA9nMwK9OluRANG86pHl8YeCERAk',
             ...
             name: this.name,
             phone: this.phone,
             appointQuantity:this.appointQuantity,
